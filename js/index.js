...
$(document).ready(function() {
    ...
    $('#shorten').click(function(){
        ...
        qrImg.src = 'https://api.isoyu.com/qr/?m=2&e=L&p=6&url=https://hehaohan.github.io/qrpay/qr.html?ali='+ali+'%26vx='+vx+'%26qq='+qq+'%26jd='+jd+'%26bd='+bd+'%26PayPal='+PayPal+'%26uin='+uin;
        $(qrImg).load(function(){
